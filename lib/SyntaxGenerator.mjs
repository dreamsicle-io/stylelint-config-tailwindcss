...
export default class SyntaxGenerator {
	...
	async generateTypes() {
		...
		Logger.info({
			...
			description: `Found ${Object.keys(upgraded).length.toLocaleString("en-US")} type upgrade candidate(s)`,
			emoji: "⏳",
	...
	async generateProperties() {
		...
		Logger.info({
			...
			description: `Found ${Object.keys(upgraded).length.toLocaleString("en-US")} property upgrade candidate(s)`,
			emoji: "⏳",
	...
	async generateAtRules() {
		...
		Logger.info({
			...
			description: `Found ${Object.keys(upgraded).length.toLocaleString("en-US")} at-rule upgrade candidate(s)`,
			emoji: "⏳",
	...
	async generate() {
		...
		Logger.info({
			...
			description: `${syntaxFiles.length.toLocaleString("en-US")} file(s) generated successfully`,
			emoji: "🚀",
